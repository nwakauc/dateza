...
export function FindMatchPanel({ name, photoUrl, selfPhotoUrl, onKeepFinding, onSendOpener }: Props) {
  return (
    <section className="find-rail-card find-match-card" aria-label="It's a match!">
      ...
      <div className="find-match-card__actions">
        <button type="button" className="shell-primary-action find-match-card__primary" onClick={onSendOpener}>
          Send an opener
        </button>
