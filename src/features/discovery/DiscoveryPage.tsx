 ...
 * separate product and allowance from Find, and where a member lands right
 * after onboarding. The backend for it does not exist yet, so this page must
 * never call `/api/v1/find` or otherwise fake curated results; it only holds
 * the route and nav destination until the curated feed ships. AppShell
 * already guarantees onboarding is complete before this mounts, so there is
 * no incomplete-onboarding branch here.
 */
