...
<div style="display:flex;align-items:center;justify-content:space-between;padding:18px 64px;position:relative;z-index:5">
  <a href="#top" style="display:block;color:inherit;text-decoration:none;cursor:pointer;display:flex;flex-direction:column;gap:2px">
  ...
  <div style="display:flex;gap:28px;align-items:center;font-size:14px;font-weight:500;color:#5F5566">
    ...
    <a href="#sign-in" style="color:#1C1720;font-weight:600;text-decoration:none;cursor:pointer">Sign In</a>
    <a href="#join" style="background:#E8375A;color:#fff;padding:12px 26px;border-radius:999px;font-weight:700;box-shadow:0 10px 26px rgba(232,55,90,.32);text-decoration:none;cursor:pointer;display:inline-block">Join Free</a>
  </div>
</div>

<div style="position:relative;padding:44px 64px 40px;overflow:visible">
  <div style="position:absolute;top:-60px;right:-80px;width:480px;height:480px;border-radius:50%;background:radial-gradient(circle,rgba(232,55,90,.07),transparent 65%)"></div>
  <div style="display:grid;grid-template-columns:minmax(480px,1fr) 760px;gap:20px;align-items:center">
    <div style="display:flex;flex-direction:column;gap:26px;position:relative;z-index:2">
      <h1 style="margin:0;font-family:'Instrument Serif',serif;font-weight:400;font-size:92px;line-height:.98;letter-spacing:-2px">Meet someone<br>who <em style="color:#E8375A">gets</em> you.</h1>
      <div style="display:flex;align-items:center;gap:14px">
        <span style="font-family:'Instrument Serif',serif;font-style:italic;font-size:40px;color:#1C1720">Right here.</span>
      ...
      <p style="margin:0;font-size:17.5px;line-height:1.65;color:#5F5566;max-width:400px;text-wrap:pretty">Real South Africans. RealMe verified. Smarter matches based on what actually matters to you.</p>
      <div style="display:flex;gap:14px;align-items:center">
        <a href="#join" style="background:#1C1720;color:#fff;padding:18px 34px;border-radius:999px;font-size:15.5px;font-weight:700;text-decoration:none;cursor:pointer;display:inline-block">Start Matching →</a>
      ...
      <div style="display:flex;gap:22px;font-size:12.5px;font-weight:600;color:#7A6F80">
        <span style="display:inline-flex;align-items:center;gap:5px"><svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="display:inline-block;vertical-align:-0.15em;flex:none"><path d="M20 13c0 5-3.5 7.5-7.66 8.95a1 1 0 0 1-.67-.01C7.5 20.5 4 18 4 13V6a1 1 0 0 1 1-1c2 0 4.5-1.2 6.24-2.72a1.17 1.17 0 0 1 1.52 0C14.51 3.81 17 5 19 5a1 1 0 0 1 1 1z"/></svg>RealMe Verified</span><span style="display:inline-flex;align-items:center;gap:5px"><svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="display:inline-block;vertical-align:-0.15em;flex:none"><rect width="18" height="11" x="3" y="11" rx="2" ry="2"/><path d="M7 11V7a5 5 0 0 1 10 0v4"/></svg>Private &amp; Secure</span><span style="display:inline-flex;align-items:center;gap:5px">🇿🇦 Made for SA</span>
      </div>
    </div>
    <div style="position:relative;height:680px">
      ...
      <a href="#discover" style="display:block;color:inherit;text-decoration:none;cursor:pointer;position:absolute;top:10px;left:200px;width:400px;height:600px;border-radius:30px;overflow:hidden;box-shadow:0 36px 90px rgba(28,23,32,.28);z-index:2">
        <img class="dz-img" src="/images/people/maya.webp" alt="Maya, 27, Cape Town" loading="eager">
...
<div style="border-top:1.5px solid #1C1720;border-bottom:1.5px solid #1C1720;padding:15px 24px;display:flex;column-gap:36px;row-gap:8px;justify-content:center;flex-wrap:wrap;font-family:'Instrument Serif',serif;font-size:19px;color:#1C1720">
  <span>Real people</span><span style="color:#E8375A"><svg width="1em" height="1em" viewBox="0 0 24 24" fill="currentColor" style="display:inline-block;vertical-align:-0.15em;flex:none"><path d="M9.94 15.5A2 2 0 0 0 8.5 14.06l-6.13-1.58a.5.5 0 0 1 0-.96L8.5 9.94A2 2 0 0 0 9.94 8.5l1.58-6.13a.5.5 0 0 1 .96 0L14.06 8.5A2 2 0 0 0 15.5 9.94l6.13 1.58a.5.5 0 0 1 0 .96L15.5 14.06a2 2 0 0 0-1.44 1.44l-1.58 6.13a.5.5 0 0 1-.96 0z"/></svg></span><span>RealMe verified</span><span style="color:#22A06B"><svg width="1em" height="1em" viewBox="0 0 24 24" fill="currentColor" style="display:inline-block;vertical-align:-0.15em;flex:none"><path d="M9.94 15.5A2 2 0 0 0 8.5 14.06l-6.13-1.58a.5.5 0 0 1 0-.96L8.5 9.94A2 2 0 0 0 9.94 8.5l1.58-6.13a.5.5 0 0 1 .96 0L14.06 8.5A2 2 0 0 0 15.5 9.94l6.13 1.58a.5.5 0 0 1 0 .96L15.5 14.06a2 2 0 0 0-1.44 1.44l-1.58 6.13a.5.5 0 0 1-.96 0z"/></svg></span><span><em>10 worth meeting, daily</em></span><span style="color:#6C4FE0"><svg width="1em" height="1em" viewBox="0 0 24 24" fill="currentColor" style="display:inline-block;vertical-align:-0.15em;flex:none"><path d="M9.94 15.5A2 2 0 0 0 8.5 14.06l-6.13-1.58a.5.5 0 0 1 0-.96L8.5 9.94A2 2 0 0 0 9.94 8.5l1.58-6.13a.5.5 0 0 1 .96 0L14.06 8.5A2 2 0 0 0 15.5 9.94l6.13 1.58a.5.5 0 0 1 0 .96L15.5 14.06a2 2 0 0 0-1.44 1.44l-1.58 6.13a.5.5 0 0 1-.96 0z"/></svg></span><span>Matches with reasons</span><span style="color:#F5B62E"><svg width="1em" height="1em" viewBox="0 0 24 24" fill="currentColor" style="display:inline-block;vertical-align:-0.15em;flex:none"><path d="M9.94 15.5A2 2 0 0 0 8.5 14.06l-6.13-1.58a.5.5 0 0 1 0-.96L8.5 9.94A2 2 0 0 0 9.94 8.5l1.58-6.13a.5.5 0 0 1 .96 0L14.06 8.5A2 2 0 0 0 15.5 9.94l6.13 1.58a.5.5 0 0 1 0 .96L15.5 14.06a2 2 0 0 0-1.44 1.44l-1.58 6.13a.5.5 0 0 1-.96 0z"/></svg></span><span>NO DNA. JUST RSA.</span>
</div>

<div style="padding:74px 64px 30px;position:relative">
  <div style="display:flex;align-items:flex-end;justify-content:space-between;margin-bottom:26px">
    <div><div style="font-size:11.5px;font-weight:800;letter-spacing:2px;color:#E8375A;margin-bottom:10px">TONIGHT, NEAR YOU</div><div style="font-family:'Instrument Serif',serif;font-size:46px;line-height:1.05">People you'd actually<br><em style="color:#E8375A">want to meet.</em></div></div>
    <a href="#discover" style="font-size:13.5px;font-weight:700;color:#E8375A;padding-bottom:8px;text-decoration:none;cursor:pointer">See more →</a>
  </div>
  <div style="display:grid;grid-template-columns:1.35fr 1fr 1fr 1.35fr;grid-auto-rows:170px;gap:16px">
    <a href="#discover" style="display:block;color:inherit;text-decoration:none;cursor:pointer;position:relative;border-radius:22px;overflow:hidden;grid-row:span 2;box-shadow:0 10px 28px rgba(28,23,32,.1)"><img class="dz-img" src="/images/people/aisha.webp" alt="Aisha, 27, Durban" loading="lazy"><div style="position:absolute;inset:auto 0 0 0;padding:50px 16px 14px;background:linear-gradient(180deg,transparent,rgba(20,12,18,.8));color:#fff;pointer-events:none"><div style="font-size:17px;font-weight:700">Aisha, 27 <span style="font-size:12px;color:#7BE0B4"><svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" style="display:inline-block;vertical-align:-0.125em;flex:none"><path d="M20 6 9 17l-5-5"/></svg></span></div><div style="font-size:12px;opacity:.88">Durban · foodie at heart</div></div><div style="position:absolute;top:12px;right:12px;background:#fff;border-radius:999px;padding:5px 11px;font-size:12px;font-weight:800;color:#22A06B;pointer-events:none">93%</div></a>
    <a href="#discover" style="display:block;color:inherit;text-decoration:none;cursor:pointer;position:relative;border-radius:22px;overflow:hidden;box-shadow:0 10px 28px rgba(28,23,32,.1)"><img class="dz-img" src="/images/people/lerato.webp" alt="Lerato, 26, Pretoria" loading="lazy"><div style="position:absolute;inset:auto 0 0 0;padding:40px 14px 12px;background:linear-gradient(180deg,transparent,rgba(20,12,18,.8));color:#fff;pointer-events:none"><div style="font-size:14.5px;font-weight:700">Lerato, 26 <span style="font-size:11px;color:#7BE0B4"><svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" style="display:inline-block;vertical-align:-0.125em;flex:none"><path d="M20 6 9 17l-5-5"/></svg></span></div><div style="font-size:11px;opacity:.88">Pretoria · sunset runner</div></div><div style="position:absolute;top:10px;right:10px;background:#fff;border-radius:999px;padding:4px 10px;font-size:11px;font-weight:800;color:#22A06B;pointer-events:none">89%</div></a>
    <a href="#discover" style="display:block;color:inherit;text-decoration:none;cursor:pointer;position:relative;border-radius:22px;overflow:hidden;box-shadow:0 10px 28px rgba(28,23,32,.1)"><img class="dz-img" src="/images/people/daniel.webp" alt="Daniel, 30, Cape Town" loading="lazy"><div style="position:absolute;inset:auto 0 0 0;padding:40px 14px 12px;background:linear-gradient(180deg,transparent,rgba(20,12,18,.8));color:#fff;pointer-events:none"><div style="font-size:14.5px;font-weight:700">Daniel, 30 <span style="font-size:11px;color:#7BE0B4"><svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" style="display:inline-block;vertical-align:-0.125em;flex:none"><path d="M20 6 9 17l-5-5"/></svg></span></div><div style="font-size:11px;opacity:.88">Cape Town · surf mornings</div></div><div style="position:absolute;top:10px;right:10px;background:#fff;border-radius:999px;padding:4px 10px;font-size:11px;font-weight:800;color:#22A06B;pointer-events:none">87%</div></a>
    <a href="#discover" style="display:block;color:inherit;text-decoration:none;cursor:pointer;position:relative;border-radius:22px;overflow:hidden;grid-row:span 2;box-shadow:0 10px 28px rgba(28,23,32,.1)"><img class="dz-img" src="/images/people/tyla.webp" alt="Tyla, 25, Gqeberha" loading="lazy"><div style="position:absolute;inset:auto 0 0 0;padding:50px 16px 14px;background:linear-gradient(180deg,transparent,rgba(20,12,18,.8));color:#fff;pointer-events:none"><div style="font-size:17px;font-weight:700">Tyla, 25 <span style="font-size:12px;color:#7BE0B4"><svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" style="display:inline-block;vertical-align:-0.125em;flex:none"><path d="M20 6 9 17l-5-5"/></svg></span></div><div style="font-size:12px;opacity:.88">Gqeberha · beach walks</div></div><div style="position:absolute;top:12px;right:12px;background:#fff;border-radius:999px;padding:5px 11px;font-size:12px;font-weight:800;color:#22A06B;pointer-events:none">88%</div></a>
    <a href="#discover" style="display:block;color:inherit;text-decoration:none;cursor:pointer;position:relative;border-radius:22px;overflow:hidden;box-shadow:0 10px 28px rgba(28,23,32,.1)"><img class="dz-img" src="/images/people/justin.webp" alt="Justin, 29, Stellenbosch" loading="lazy"><div style="position:absolute;inset:auto 0 0 0;padding:40px 14px 12px;background:linear-gradient(180deg,transparent,rgba(20,12,18,.8));color:#fff;pointer-events:none"><div style="font-size:14.5px;font-weight:700">Justin, 29 <span style="font-size:11px;color:#7BE0B4"><svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" style="display:inline-block;vertical-align:-0.125em;flex:none"><path d="M20 6 9 17l-5-5"/></svg></span></div><div style="font-size:11px;opacity:.88">Stellenbosch · wine routes</div></div><div style="position:absolute;top:10px;right:10px;background:#fff;border-radius:999px;padding:4px 10px;font-size:11px;font-weight:800;color:#22A06B;pointer-events:none">86%</div></a>
    <a href="#discover" style="display:block;color:inherit;text-decoration:none;cursor:pointer;position:relative;border-radius:22px;overflow:hidden;box-shadow:0 10px 28px rgba(28,23,32,.1)"><img class="dz-img" src="/images/people/thandi.webp" alt="Thandi, 28, Soweto" loading="lazy"><div style="position:absolute;inset:auto 0 0 0;padding:40px 14px 12px;background:linear-gradient(180deg,transparent,rgba(20,12,18,.8));color:#fff;pointer-events:none"><div style="font-size:14.5px;font-weight:700">Thandi, 28 <span style="font-size:11px;color:#7BE0B4"><svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" style="display:inline-block;vertical-align:-0.125em;flex:none"><path d="M20 6 9 17l-5-5"/></svg></span></div><div style="font-size:11px;opacity:.88">Soweto · amapiano nights</div></div><div style="position:absolute;top:10px;right:10px;background:#fff;border-radius:999px;padding:4px 10px;font-size:11px;font-weight:800;color:#22A06B;pointer-events:none">90%</div></a>
  </div>
</div>

<div style="padding:64px 64px 30px;display:grid;grid-template-columns:1fr 1fr;gap:22px">
  <a href="#discover" style="display:block;color:inherit;text-decoration:none;cursor:pointer;border-radius:28px;padding:40px 42px;background:linear-gradient(150deg,#FFF3F6,#fff 70%);border:1px solid #FBE3E9;display:flex;gap:26px;align-items:center">
    <div style="flex:1;display:flex;flex-direction:column;gap:13px">
      ...
      <div style="font-family:'Instrument Serif',serif;font-size:31px;line-height:1.12">10 people worth meeting. <em>Every day.</em></div>
    ...
    <div style="position:relative;width:150px;height:190px;flex:none">
  ...
  <a href="#find" style="display:block;color:inherit;text-decoration:none;cursor:pointer;border-radius:28px;padding:40px 42px;border:1px solid #F0EAEE;display:flex;gap:26px;align-items:center">
    <div style="flex:1;display:flex;flex-direction:column;gap:13px">
      ...
      <div style="font-family:'Instrument Serif',serif;font-size:31px;line-height:1.12">Know what you want? <em>Go find them.</em></div>
    ...
    <div style="width:150px;height:190px;border-radius:16px;overflow:hidden;flex:none;position:relative;box-shadow:0 12px 30px rgba(28,23,32,.14)">
...
<div style="margin:64px;background:#FBFAFF;border:1px solid #EFEBFA;border-radius:34px;padding:56px 60px;display:grid;grid-template-columns:1fr 1fr;gap:52px;align-items:center;position:relative;overflow:hidden">
  ...
  <div style="display:flex;flex-direction:column;gap:18px">
    ...
    <div style="font-family:'Instrument Serif',serif;font-size:44px;line-height:1.06">Compatibility that goes <em style="color:#6C4FE0">beyond photos.</em></div>
    <p style="margin:0;font-size:15px;line-height:1.7;color:#5F5566;max-width:440px">Our AI learns what matters to you and surfaces people you're more likely to genuinely connect with. You stay in control — it just does the homework.</p>
    <div style="display:flex;flex-direction:column;gap:10px;max-width:410px;font-size:13px;font-weight:600;color:#4A414F">
  ...
  <div style="display:flex;align-items:center;justify-content:center;gap:24px">
    <a href="#discover" style="display:block;color:inherit;text-decoration:none;cursor:pointer;width:130px;height:130px;border-radius:50%;overflow:hidden;border:4px solid #fff;box-shadow:0 16px 40px rgba(28,23,32,.16)"><img class="dz-img" src="/images/people/pair-you.webp" alt="You" loading="lazy"></a>
    ...
    <a href="#discover" style="display:block;color:inherit;text-decoration:none;cursor:pointer;width:130px;height:130px;border-radius:50%;overflow:hidden;border:4px solid #fff;box-shadow:0 16px 40px rgba(28,23,32,.16)"><img class="dz-img" src="/images/people/pair-them.webp" alt="Your match" loading="lazy"></a>
  </div>
</div>

<div style="padding:6px 64px 26px">
  <div style="display:flex;align-items:baseline;justify-content:space-between;margin-bottom:22px">
    <div style="font-family:'Instrument Serif',serif;font-size:44px">Across SA, <em style="color:#E8375A">love lives here.</em></div>
    <a href="#cities" style="font-size:13.5px;font-weight:700;color:#E8375A;text-decoration:none;cursor:pointer">See all cities →</a>
  </div>
  <div style="display:grid;grid-template-columns:1.5fr 1fr 1fr 1.5fr 1fr 1fr;gap:14px">
    ...
    <a href="#cities" style="display:block;color:inherit;text-decoration:none;cursor:pointer;position:relative;height:190px;border-radius:20px;overflow:hidden"><img class="dz-img" src="/images/places/durban.webp" alt="Durban" loading="lazy"></a>
    <a href="#cities" style="display:block;color:inherit;text-decoration:none;cursor:pointer;position:relative;height:190px;border-radius:20px;overflow:hidden"><img class="dz-img" src="/images/places/pretoria.webp" alt="Pretoria" loading="lazy"></a>
    <a href="#cities" style="display:block;color:inherit;text-decoration:none;cursor:pointer;position:relative;height:190px;border-radius:20px;overflow:hidden"><img class="dz-img" src="/images/places/gqeberha.webp" alt="Gqeberha" loading="lazy"></a>
    <a href="#cities" style="display:block;color:inherit;text-decoration:none;cursor:pointer;position:relative;height:190px;border-radius:20px;overflow:hidden"><img class="dz-img" src="/images/places/bloemfontein.webp" alt="Bloemfontein" loading="lazy"></a>
  </div>
</div>

<div style="padding:58px 64px;display:grid;grid-template-columns:380px 1fr;gap:48px;align-items:center">
  <div style="display:flex;flex-direction:column;gap:16px">
    <div style="font-family:'Instrument Serif',serif;font-size:44px;line-height:1.08">It's more than dating. It's <em style="color:#F5B62E">your next chapter.</em></div>
    ...
    <a href="#sa-lifestyle" style="align-self:flex-start;background:#1C1720;color:#fff;padding:15px 30px;border-radius:999px;font-size:14px;font-weight:700;text-decoration:none;cursor:pointer;display:inline-block">Explore SA Lifestyle</a>
  </div>
  <div style="display:grid;grid-template-columns:repeat(3,1fr);grid-auto-rows:145px;gap:13px">
    <a href="#sa-lifestyle" style="display:block;color:inherit;text-decoration:none;cursor:pointer;position:relative;border-radius:18px;overflow:hidden;grid-row:span 2"><img class="dz-img" src="/images/lifestyle/city-nights.webp" alt="City nights — bright lights, big vibes" loading="lazy"></a>
    <a href="#sa-lifestyle" style="display:block;color:inherit;text-decoration:none;cursor:pointer;position:relative;border-radius:18px;overflow:hidden"><img class="dz-img" src="/images/lifestyle/beach-days.webp" alt="Beach days — sun, sea, good company" loading="lazy"></a>
    <a href="#sa-lifestyle" style="display:block;color:inherit;text-decoration:none;cursor:pointer;position:relative;border-radius:18px;overflow:hidden"><img class="dz-img" src="/images/lifestyle/road-trips.webp" alt="Road trips — new places, new stories" loading="lazy"></a>
    <a href="#sa-lifestyle" style="display:block;color:inherit;text-decoration:none;cursor:pointer;position:relative;border-radius:18px;overflow:hidden"><img class="dz-img" src="/images/lifestyle/good-food.webp" alt="Good food — local flavours, real good" loading="lazy"></a>
    <a href="#sa-lifestyle" style="display:block;color:inherit;text-decoration:none;cursor:pointer;position:relative;border-radius:18px;overflow:hidden"><img class="dz-img" src="/images/lifestyle/live-events.webp" alt="Live events — music, culture, connection" loading="lazy"></a>
  </div>
</div>

<div style="margin:0 64px 64px;background:#F2FAF6;border:1px solid #DBF0E5;border-radius:34px;padding:52px 58px;display:grid;grid-template-columns:1fr 1fr;gap:44px;align-items:center">
  <div style="display:flex;flex-direction:column;gap:16px">
    ...
    <div style="font-family:'Instrument Serif',serif;font-size:42px;line-height:1.08">Real people should meet <em style="color:#22A06B">real people.</em></div>
  ...
  <div style="display:flex;justify-content:center">
    <div style="background:#fff;border-radius:26px;padding:28px;box-shadow:0 22px 55px rgba(34,160,107,.16);display:flex;flex-direction:column;gap:16px;width:330px">
      <div style="display:flex;align-items:center;gap:14px">
        <a href="#safety" style="display:block;color:inherit;text-decoration:none;cursor:pointer;width:64px;height:64px;border-radius:50%;overflow:hidden"><img class="dz-img" src="/images/people/verify-selfie.webp" alt="Selfie verification in progress" loading="lazy"></a>
...
<div style="padding:0 64px 70px;display:grid;grid-template-columns:1fr 460px;gap:48px;align-items:center">
  <div style="display:flex;gap:18px;justify-content:center">
    <div style="width:215px;background:#1C1720;border-radius:32px;padding:8px;box-shadow:0 24px 60px rgba(28,23,32,.25);transform:rotate(-3deg)">
      <div style="background:#fff;border-radius:26px;overflow:hidden;height:430px;display:flex;flex-direction:column">
    ...
    <div style="width:215px;background:#1C1720;border-radius:32px;padding:8px;box-shadow:0 24px 60px rgba(28,23,32,.25);z-index:1">
      <div style="background:#fff;border-radius:26px;overflow:hidden;height:430px;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:12px;padding:20px;text-align:center">
        <a href="#discover" style="display:block;color:inherit;text-decoration:none;cursor:pointer;display:flex"><div style="width:66px;height:66px;border-radius:50%;overflow:hidden;border:3px solid #fff;box-shadow:0 4px 14px rgba(0,0,0,.15)"><img class="dz-img" src="/images/people/match-you.webp" alt="You" loading="lazy"></div><div style="width:66px;height:66px;border-radius:50%;overflow:hidden;border:3px solid #fff;box-shadow:0 4px 14px rgba(0,0,0,.15);margin-left:-16px"><img class="dz-img" src="/images/people/match-them.webp" alt="Your match" loading="lazy"></div></a>
        ...
        <a href="#matches" style="background:#E8375A;color:#fff;font-size:11px;font-weight:700;padding:10px 22px;border-radius:999px;text-decoration:none;cursor:pointer;display:inline-block">Send a message</a>
        <a href="#discover" style="font-size:11px;font-weight:600;color:#7A6F80;text-decoration:none;cursor:pointer">Keep exploring</a>
      </div>
    </div>
    <div style="width:215px;background:#1C1720;border-radius:32px;padding:8px;box-shadow:0 24px 60px rgba(28,23,32,.25);transform:rotate(3deg)">
      <div style="background:#fff;border-radius:26px;overflow:hidden;height:430px;display:flex;flex-direction:column">
  ...
  <div style="display:flex;flex-direction:column;gap:18px">
    ...
    <div style="font-family:'Instrument Serif',serif;font-size:42px;line-height:1.08">Technology that brings the right people together.</div>
    <div style="display:flex;flex-direction:column;gap:16px">
...
<div style="position:relative;margin:0 64px 30px;background:#1C1720;border-radius:36px;padding:80px 60px;text-align:center;overflow:hidden">
  ...
  <div style="font-family:'Instrument Serif',serif;font-size:64px;line-height:1.05;color:#fff">Your person is out there.<br><em style="color:#FF6B8A">Right here.</em></div>
...
<div style="display:flex;align-items:center;justify-content:space-between;padding:22px 64px 30px;font-size:12px;color:#9A8F98">
  ...
  <div style="display:flex;gap:24px"><a href="#safety" style="color:inherit;text-decoration:none;cursor:pointer">Safety</a><a href="#privacy" style="color:inherit;text-decoration:none;cursor:pointer">Privacy</a><a href="#help" style="color:inherit;text-decoration:none;cursor:pointer">Help Centre</a><a href="#careers" style="color:inherit;text-decoration:none;cursor:pointer">Careers</a></div>
