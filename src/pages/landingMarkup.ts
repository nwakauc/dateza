...
<div class="dz-section dz-tonight" style="padding:74px 64px 30px;position:relative">
...
<div class="dz-section dz-discovery-find" style="padding:64px 64px 30px;display:grid;grid-template-columns:1fr 1fr;gap:22px">
  ...
  <a href="#find" class="dz-df-card" style="display:block;color:inherit;text-decoration:none;cursor:pointer;border-radius:28px;padding:40px 42px;border:1px solid #F0EAEE;display:flex;gap:26px;align-items:center">
    <div style="flex:1;display:flex;flex-direction:column;gap:13px">
...
<div class="dz-section dz-ai-match" style="margin:64px;background:#FBFAFF;border:1px solid #EFEBFA;border-radius:34px;padding:56px 60px;display:grid;grid-template-columns:1fr 1fr;gap:52px;align-items:center;position:relative;overflow:hidden">
  ...
  <div class="dz-pair-visual" style="display:flex;align-items:center;justify-content:center;gap:24px">
    <a href="#discover" class="dz-pair-photo" style="display:block;color:inherit;text-decoration:none;cursor:pointer;width:130px;height:130px;border-radius:50%;overflow:hidden;border:4px solid #fff;box-shadow:0 16px 40px rgba(28,23,32,.16)"><img class="dz-img" src="/images/people/pair-you.webp" alt="You" loading="lazy"></a>
    ...
    <a href="#discover" class="dz-pair-photo" style="display:block;color:inherit;text-decoration:none;cursor:pointer;width:130px;height:130px;border-radius:50%;overflow:hidden;border:4px solid #fff;box-shadow:0 16px 40px rgba(28,23,32,.16)"><img class="dz-img" src="/images/people/pair-them.webp" alt="Your match" loading="lazy"></a>
  </div>
</div>

<div class="dz-section dz-cities" style="padding:6px 64px 26px">
...
<div class="dz-section dz-lifestyle" style="padding:58px 64px;display:grid;grid-template-columns:380px 1fr;gap:48px;align-items:center">
  ...
  <div class="dz-lifestyle-mosaic" style="display:grid;grid-template-columns:repeat(3,1fr);grid-auto-rows:145px;gap:13px">
    <a href="#sa-lifestyle" class="dz-lifestyle-card--tall" style="display:block;color:inherit;text-decoration:none;cursor:pointer;position:relative;border-radius:18px;overflow:hidden;grid-row:span 2"><img class="dz-img" src="/images/lifestyle/city-nights.webp" alt="City nights — bright lights, big vibes" loading="lazy"></a>
...
<div class="dz-section dz-realme" style="margin:0 64px 64px;background:#F2FAF6;border:1px solid #DBF0E5;border-radius:34px;padding:52px 58px;display:grid;grid-template-columns:1fr 1fr;gap:44px;align-items:center">
  <div style="display:flex;flex-direction:column;gap:16px">
...
<div class="dz-section dz-showcase" style="padding:0 64px 70px;display:grid;grid-template-columns:1fr 460px;gap:48px;align-items:center">
...
<div class="dz-section dz-cta" style="position:relative;margin:0 64px 30px;background:#1C1720;border-radius:36px;padding:80px 60px;text-align:center;overflow:hidden">
